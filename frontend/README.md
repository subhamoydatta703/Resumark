...
- **Error & Rate Limit Handling**: Gracefully handles and displays backend-returned error messages (such as `429 Too Many Requests`) directly inside the dashboard workspace.
